...
- 📦 **多协议支持** - 支持 9 种 sing-box 代理协议以及 Argo 临时隧道和固定隧道节点的部署
...
- 📊 **可视化管理** - 查看所有中转路由和落地节点
- 🔀 **端口转发** - 利用singbox原生支持的端口转发，支持TCP、UDP端口转发
...
```
(curl -LfsS https://raw.githubusercontent.com/qianyianyi/singbox-lite/main/singbox.sh -o /usr/local/bin/sb || wget -q https://raw.githubusercontent.com/qianyianyi/singbox-lite/main/singbox.sh -O /usr/local/bin/sb) && chmod +x /usr/local/bin/sb && sb
```
